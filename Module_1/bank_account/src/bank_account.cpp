...
void BankAccount::Print()const{
    std::cout << "Account num: " <<  GetNumber() << ", owned by: " \
    << GetOwner() << ", balance: " << GetBalance() << " eur." << std::endl;
}

bool Transfer(BankAccount &source_account, 
                BankAccount &target_account,double amount)
{
